    ...
    <div class="row">
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="slider-add-form" action="{{route('admin.contact_us.banner')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <?php
                        $banner = \App\Models\Contractus::all();
                        if ($banner->isEmpty()) {?>
                                    ...
                                    <tr class="slider-row-{{$bn->id}}">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form id="delete-form-{{$bn->id}}" method="post"
                                                  action="{{route('admin.contact_us.delete', $bn->id)}}"
                                                  style="display: none">
                                                @csrf
                                                @method('DELETE')
                                            </form>
